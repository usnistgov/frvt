...
Null Implementation
===============================
There is a null implementation of the FRVT QUALITY API in ./src/nullImpl.  While the 
...
5) Upon successful validation, an archive will be generated named 
   libfrvt_quality_<company>_<three-digit submission sequence>.tar.gz
...
for certain tasks as detailed in the FRVT Ongoing Quality API document.
