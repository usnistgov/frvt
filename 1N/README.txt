...
IMPORTANT NOTES
===============================
Please confirm that your software can handle very very large enrollment database sizes.  Specifically, please ensure
...
Null Implementation
===============================
There is a null implementation of the FRVT 1:N API in ./src/nullImpl.  While the 
